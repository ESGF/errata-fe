...
// Set API base url.
APP.constants.API_BASE_URL = APP.constants.URLS.API[APP.constants.MODE];

// Set viewerBaseURL.
APP.constants.VIEWER_BASE_URL = APP.constants.URLS.VIEWER_PAGE[APP.constants.MODE];
